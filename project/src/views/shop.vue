<template>
	<div>
		...
		<div style="margin-top: 20px;">
			<el-row>
				<el-col :span="19">
					<div class="goods-content" v-for="(o,index) in 4" :key='o'>
						<el-row>
							<el-col :span='6' v-for="(o,index) in 4" :key='o' ><gd-box :pricea="ddd" :gdTitle="sss"></gd-box></el-col>
						</el-row>
					</div>
					</el-col>
				<el-col :span="5">
					<div class="ad-content">
						...
						<hr />
						<ad-box v-for='(o,index) in 2' :key='o' :price='100'></ad-box>
					</div>
				</el-col>
			</el-row>
		</div>
...
<script>
	...
	import GdBox from '../components/goodsBox.vue'
export default {
	components: {
		'ad-box': AdBox,
		'gd-box': GdBox
...
.search-box .el-input-group__append {
	border: 1px solid #9b59df;
	background-color: #9b59df;
}
